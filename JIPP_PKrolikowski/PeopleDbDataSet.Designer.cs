...
namespace JIPP_PKrolikowski {
    ...
    public partial class PeopleDbDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Forename, string Surname) {
...
namespace JIPP_PKrolikowski.PeopleDbDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Forename], [Surname]) VALUES (@Forename, @Surname);\r\n" +
                "SELECT Id, Forename, Surname FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Forename] = @Forename, [Surname] = @Surname WHERE (([Id" +
                "] = @Original_Id));\r\nSELECT Id, Forename, Surname FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::JIPP_PKrolikowski.Properties.Settings.Default.PeopleDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Forename, Surname FROM dbo.[Table]";
        ...
        public virtual int Fill(PeopleDbDataSet.TableDataTable dataTable) {
        ...
        public virtual PeopleDbDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PeopleDbDataSet.TableDataTable dataTable = new PeopleDbDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PeopleDbDataSet.TableDataTable dataTable) {
        ...
        public virtual int Update(string Forename, string Surname, int Original_Id, int Id) {
            if ((Forename == null)) {
                throw new global::System.ArgumentNullException("Forename");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Forename, string Surname, int Original_Id) {
            return this.Update(Forename, Surname, Original_Id, Original_Id);
        }
    }
